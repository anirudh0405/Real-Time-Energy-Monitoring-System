...
const char* mqtt_server = "cadfcd44d9104fc3a57a58ed5043a***.s1.eu.hivemq.cloud";
const int mqtt_port = 8883;
const char* mqtt_username = "******";  // Replace with HiveMQ username
const char* mqtt_password = "******";  // Replace with HiveMQ password
